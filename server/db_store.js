...
const initialData = {
  projects: [
    ...
    },
    {
      ...
      description: 'A dynamic, high-performance web app crafted with HTML, CSS, JavaScript, and Node.js REST API with relational database backend.',
      category: 'Full Stack',
      image: '/project2.jpg',
      ...
      demo_url: '#',
      featured: 1,
      architecture: 'Node.js Server + Modular Vanilla CSS UI + Relational Database Layer',
